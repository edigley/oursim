...
import com.edigley.oursim.policy.ranking.ResourceRankingPolicy;
...
public class Job extends ComputableElement implements Comparable<Job> {
	 ...
	 * 
	 * @see com.edigley.oursim.entities.ComputableElement#preempt(long)
	 */
	@Override
	 ...
	 * 
	 * @see com.edigley.oursim.entities.ComputableElement#getNumberOfPreemptions()
	 */
	@Override
