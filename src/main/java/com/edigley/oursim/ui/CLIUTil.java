...
public class CLIUTil {
	...
	public static String getSummaryStatistics(ComputingElementEventCounter c, String instance, String limit, String group, boolean groupedCloudUser,
			int nPeers, int nMachines, int upp, double utilization, double realUtilization, long goodput, long badput, long avTime, double cost, long simulationDuration, String simulationDurationF) {
		...
		try {
			 ...
			 * at com.edigley.oursim.ui.CLIUTil.getSummaryStatistics(CLIUTil.java:63)
			 * at com.edigley.oursim.ui.CLIUTil.formatSummaryStatistics(CLIUTil.java:151)
			 * at com.edigley.oursim.ui.CLI.main(CLI.java:207)
			 * </pre>
			 */
			hostName = "NA";
			ipAddress = "NA";
		...
		StringBuilder sb = new StringBuilder(
				"# submitted finished preempted notStarted submittedTasks finishedTasks success sumOfJobsMakespan sumOfTasksMakespan finishedCost preemptedCost totalCost costByTask nPeers nMachines upp instance limit group groupedCloudUser utilization realUtilization goodput badput avTime cost hostname ipaddress simulationDuration simulationDurationF"
						+ "\n");
	...
	public static String formatSummaryStatistics(ComputingElementEventCounter c, String instance, String limit, String group, boolean groupedCloudUser,
		...
		resume += getSummaryStatistics(c, instance, limit, group, groupedCloudUser, nPeers, nMachines, upp, utilization, realUtilization, goodput, badput, avTime, cost, simulationDuration,
				simulationDurationF);
		return resume;
	}
